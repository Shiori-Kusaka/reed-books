...
function memo() {
  ...
  submit.addEventListener("click", function (e) {
    ...
    XHR.onload = function () {
      ...
      var HTML = "\n      <div class=\"memo-container\" data-id=".concat(item.id, ">\n      <div class=\"memo-title\">\n        <span>\u30BF\u30A4\u30C8\u30EB : </span>\n        ").concat(item.title, "\n      </div>\n      <div class=\"memo-text\">\n        ").concat(item.content, "\n      </div>\n      <div class=\"memo-destroy\">\n        <%=link_to 'destroy', \"/books/#{memo.book.id}/memos/#{memo.id}\", method: :delete %>\n        <%=link_to 'edit', \"/books/#{memo.book.id}/memos/#{memo.id}/edit\", class: \"post-edit\", remote: true %>\n      </div>\n    </div>");
...
/******/ });
//# sourceMappingURL=application-2dc117ec20b7cbfff2f2.js.map